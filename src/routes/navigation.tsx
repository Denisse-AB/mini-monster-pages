    ...
    <Fragment>
      <div className="flex items-center justify-center mt-5">
        <div className="inline-flex rounded-md shadow-sm" role="group">
          ...
          <NavLink type="button" to="https://github.com/denisse-ab/Mini-Monster-Store" className="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-card-bg focus:z-10 focus:ring-2 focus:ring-card-bg focus:text-card-bg">
